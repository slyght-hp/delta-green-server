...
<Typewriter cascade interval={20} >  <p class="text-center pb-4"> This is a copy of Alphonse's "Axioms for Agents." </p>

  <p class="text-center"> I have no idea whether they actually came from Alphonse. </p>
